...
module Jekyll
  class GithubApiV3 < Jekyll::Generator
    ...
    def generate site
      ...
      begin
        ...
        # print_message "Jekyll Github Api v3 plugin done."
  ...
  class GithubConfigFileNotFound < StandardError
    def message
      "Abort.\nGithubApiV3::GithubConfigFileNotFound: github.yml file not found in _data directory"
    end
  end
  ...
  class GithubLoginNotFound < StandardError
    def message
      "Abort.\nGithubApiV3::GithubLoginNotFound: no login found in _data/github.yml"
    end
  end
